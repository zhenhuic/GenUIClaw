/**
 * Mobile conversation store.
 *
 * Identical logic to the desktop renderer/store/conversation-store.ts.
 * The key difference is that window.electronAPI is provided by remote-api.ts
 * (via the relay), not by Electron's preload bridge.
 */
